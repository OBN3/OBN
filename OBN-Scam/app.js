...
const I18N = {
  he: {
    ...
    questions: {
      ...
      alreadyActed: { t: "האם כבר לחצת בהודעה שקיבלת על קישור, או מסרת פרטים כלשהם, או שילמת תשלום כלשהו?", s: "", e: "פעולה שבוצעה דורשת טיפול מיידי. אם כבר לחצת על קישור או פתחת קובץ בהודעה - כדאי לדווח על כך במהירות (למשטרה, למוקד 119 של מערך הסייבר, או לקרוב משפחה, ", n: "פעולה שכבר בוצעה" }
    },
    results: {
      ...
      emgOpts: ["צרו קשר עם הגורם הרשמי שלכאורה שלח את ההודעה (למשל - אם נראה שההודעה נשלחה מקופת החולים או הבנק שלכם - פנו אליו באופן עצמאי).","פנו לבנק דרך מספר טלפון רשמי, או כתובת אינטרנט שנכונה בודאות.","אם מסרתם סיסמה — החליפו אותה מייד.","אם מסרתם קוד — פנו לגוף הרלוונטי הרשמי.","פנו למוקד 119 של מערך הסייבר.","התייעצו עם גורם מקצועי."],
