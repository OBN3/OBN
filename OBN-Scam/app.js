...
const I18N = {
  he: {
    ...
    questions: {
      ...
      linkIncluded: { t: "האם היה בהודעה קישור או קובץ שלחצת או התבקשת ללחוץ עליו?", s: "", e: "קישורים עלולים להוביל לאתרים מתחזים. קבצים עלולים להכיל תוכן מסוכן", n: "קישור חשוד" },
