...
const I18N = {
  he: {
    ...
    intro: {
      title: "👋 ברוכים הבאים!",
      text: "קיבלת הודעה, פרסום, שיחה או הצעה שנראים לך קצת חשודים?<br />ענו על כמה שאלות קצרות ותקבלו הסבר האם יש סימני אזהרה, ומה כדאי לעשות עכשיו.",
    ...
    questions: {
      urgentAction: { t: "האם ביקשו ממך לפעול מיד?", s: "למשל: \"דחוף\", \"היום בלבד\", \"החשבון ייחסם\", \"נותרו כמה דקות\".", e: "לחץ לפעולה מיידית הוא סימן נפוץ בהונאות.", n: "לחץ לפעולה מיידית" },
      fearThreat: { t: "האם ההודעה ניסתה להפחיד אותך?", s: "למשל: חסימת חשבון, קנס, חוב, או סכנה מיידית.", e: "הודעות שמפחידות אותנו גורמות להחלטות בלחץ.", n: "איום או הפחדה" },
      personalDetails: { t: "האם ביקשו ממך למסור פרטים אישיים?", s: "למשל: סיסמה, קוד בטלפון, ת.ז או פרטי אשראי.", e: "בקשה לפרטים רגישים דרך קישור היא סימן אזהרה.", n: "בקשה לפרטים אישיים" },
      moneyPayment: { t: "האם ביקשו ממך לשלם, להעביר כסף, או להשקיע?", s: "", e: "כאשר מבקשים כסף דרך הודעה, חשוב לבדוק היטב.", n: "בקשה לכסף או תשלום" },
      linkIncluded: { t: "האם היה בהודעה קישור שלחצת או התבקשת ללחוץ עליו?", s: "", e: "קישורים עלולים להוביל לאתרים מתחזים.", n: "קישור חשוד" },
      senderKnown: { t: "האם את/ה בטוח/ה מי שלח את ההודעה?", s: "", e: "מקור לא ידוע דורש זהירות כפולה.", n: "מקור לא ברור" },
      knownOrganization: { t: "האם ההודעה נראתה כאילו היא מגיעה מגוף מוכר?", s: "למשל: בנק, דואר, משטרה, ביטוח לאומי.", e: "הונאות משתמשות בשמות מוכרים ליצירת אמון.", n: "התחזות לגוף מוכר" },
      tooGoodToBeTrue: { t: "האם הציעו לך משהו שנשמע טוב מדי?", s: "למשל: פרס, זכייה, החזר כספי או רווח מהיר.", e: "הצעות של רווח מפתיע עלולות להיות הונאה.", n: "הצעה טובה מדי" },
      strangeLanguage: { t: "האם היו שגיאות כתיב או ניסוח מוזר?", s: "", e: "שגיאות יכולות להיות סימן מחשיד כשהן מצורפות לסימנים אחרים.", n: "ניסוח מוזר או שגיאות כתיב" },
      checkedOfficialChannel: { t: "האם בדקת דרך אתר או מספר רשמי שמצאת בעצמך?", s: "", e: "בדיקה בערוץ רשמי היא דרך טובה להפחית סיכון.", n: "לא נבדק בערוץ רשמי" },
      consultedSomeone: { t: "האם התייעצת עם אדם נוסף לפני שפעלת?", s: "", e: "התייעצות היא אחת ההגנות הטובות ביותר.", n: "לא התייעץ עם אחר" },
      alreadyActed: { t: "האם כבר לחצת על קישור, מסרת פרטים או שילמת?", s: "", e: "פעולה שבוצעה דורשת טיפול מיידי.", n: "פעולה שכבר בוצעה" }
    },
    results: {
      lowTitle: "רמת חשד נמוכה", lowDesc: "לא זוהו הרבה סימני אזהרה לפי התשובות שלך.<br />תמיד כדאי לבדוק בערוץ רשמי.",
      medTitle: "פעלת נכון, אך ישנן נורות אזהרה", medDesc: "<strong>כל הכבוד שעצרת לבדוק!</strong><br />את רוב הדברים עשית בסדר, אבל המערכת זיהתה כמה סימנים קטנים. מומלץ לא למהר, ולעשות בדיקה קצרה בערוץ הרשמי.",
      highTitle: "רמת חשד גבוהה", highDesc: "הפרסום כולל כמה סימני אזהרה משמעותיים.<br />מומלץ לא ללחוץ על קישורים, לא למסור פרטים, ולבדוק בערוץ רשמי.",
      ...
      learnTitle: "📚 מה למדנו?",
      learnRemember: "זכור/י: הונאות נבנות כדי להטעות. עצירה ובדיקה הן סימן לחוכמה.",
      emgTitle: "⚠️ פעולה מיידית מומלצת",
      emgSub: "מכיוון שכבר לחצת, מסרת פרטים או שילמת:",
      emgOpts: ["עצור/י קשר עם הגורם שפנה.","פנה/י לבנק דרך מספר רשמי.","אם מסרת סיסמה — החלף/י אותה.","אם מסרת קוד — פנה לגוף הרלוונטי.","התייעץ/י עם גורם מקצועי."],
  ...
  en: {
    ...
    questions: {
      ...
      linkIncluded: { t: "Was there a link you were asked to click?", s: "", e: "Links can lead to fake websites mimicking real ones.", n: "Suspicious Link" },
  ...
  ar: {
    ...
    questions: {
      ...
      linkIncluded: { t: "هل احتوت الرسالة على رابط ضغطت عليه أو طُلب منك ذلك؟", s: "", e: "قد تؤدي الروابط إلى مواقع مزيفة.", n: "رابط مشبوه" },
  ...
  ru: {
    ...
    questions: {
      ...
      linkIncluded: { t: "В сообщении была ссылка, по которой вас просили перейти?", s: "", e: "Ссылки могут вести на поддельные сайты.", n: "Подозрительная ссылка" },
