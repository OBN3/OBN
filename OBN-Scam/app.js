...
const I18N = {
  he: {
    ...
    questions: {
      ...
      fearThreat: { t: "האם בהודעה ניסו להפחיד אותך?", s: "למשל: החשבון שלך יחסם, צפי לקנס, חוב, או סכנה מיידית, אם לא תבצעו את פעולה מסויימת.", e: "הודעות שמפחידות אותנו גורמות להחלטות שלא התכוונו אליהן.", n: "איום או הפחדה" },
      ...
      moneyPayment: { t: "האם ביקשו ממך לשלם, להעביר כסף, או הציעו לך להשקיע כסף?", s: "", e: "כאשר מבקשים כסף דרך הודעה, חשוב לבדוק היטב. ברוב המקרים מדובר בהונאה", n: "בקשה לכסף או תשלום" },
      ...
      consultedSomeone: { t: "האם התייעצת עם אדם נוסף לגבי תוכן ההודעה או ההצעה שהיצוע בהודעה לפני שפעלת?", s: "", e: "התייעצות היא אחת ההגנות הטובות ביותר.", n: "לא התייעץ עם אחר" },
      alreadyActed: { t: "האם כבר לחצת בהודעה שקיבלת על קישור, או מסרת פרטים או שילמת?", s: "", e: "פעולה שבוצעה דורשת טיפול מיידי. אם כבר לחצת על קישור או פתחת קובץ בהודעה - כדאי לדווח על כך במהירות (למשטרה, או לקרוב משפחה, ", n: "פעולה שכבר בוצעה" }
    },
    results: {
