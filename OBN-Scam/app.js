...
const I18N = {
  he: {
    ...
    questions: {
      ...
      alreadyActed: { t: "האם כבר לחצת בהודעה שקיבלת על קישור, או מסרת פרטים או שילמת?", s: "", e: "פעולה שבוצעה דורשת טיפול מיידי. אם כבר לחצת על קישור או פתחת קובץ בהודעה - כדאי לדווח על כך במהירות (למשטרה, למוקד 119 של מערך הסייבר, או לקרוב משפחה, ", n: "פעולה שכבר בוצעה" }
    },
    results: {
